...
contract TestCurrentReclaimableSurplusOf_Local is JBTerminalStoreSetup {
    ...
    function test_GivenCurrentSurplusEqZero() external {
        ...
        uint256 reclaimable =
            _store.currentReclaimableSurplusOf(_projectId, _tokenCount, address(_terminal), _contexts, 18, _currency);
    ...
    function test_GivenCurrentSurplusGtZero() external whenUseTotalSurplusEqFalse whenProjectHasBalance {
        ...
        uint256 reclaimable =
            _store.currentReclaimableSurplusOf(_projectId, 1e18, address(_terminal), _contexts, 18, _currency);
